...
def make_request_enhanced(method, url, headers=None, json_data=None, data=None, timeout=30, verify=True):
...
def main():
    ...
    parser.add_argument("method_or_url", nargs="?", help="HTTP method or URL (if method not specified, defaults to GET)")
    parser.add_argument("url", nargs="?", help="URL to request")
    
    # Request options
    parser.add_argument("-X", "--method", help="HTTP method (GET, POST, PUT, DELETE, etc.)")
    ...
    parser.add_argument("-p", "--param", action="append", help="Query parameter (format: 'key=value')")
    
    # Output options
    parser.add_argument("-v", "--verbose", action="store_true", help="Verbose output")
    parser.add_argument("--no-headers", action="store_true", help="Don't show response headers")
    ...
    parser.add_argument("--set", action="append", help="Set variable (format: 'key=value')")
    
    # Utility
    parser.add_argument("--check-deps", action="store_true", help="Check optional dependency status")
    parser.add_argument("--version", action="version", version=f"test-endpoints {__version__}")
