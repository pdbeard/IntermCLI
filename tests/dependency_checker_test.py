#!/usr/bin/env python3
"""
Tests for the shared dependency_checker module.
"""
import logging
import unittest
...
class TestDependencyChecker(unittest.TestCase):
    """Test suite for the DependencyChecker class."""

    def setUp(self):
        """Set up test fixtures."""
        self.dependency_checker = DependencyChecker("test_tool")

    def test_init(self):
        """Test initialization with defaults."""
        loader = DependencyChecker("test_tool")
        ...
        loader = DependencyChecker("custom_tool", logger=custom_logger)
    ...
    def test_get_default_logger(self):
        ...
        logger = self.dependency_checker._get_default_logger()
    ...
    def test_is_module_available_existing(self):
        ...
        self.assertTrue(self.dependency_checker._is_module_available("os"))
        self.assertTrue(self.dependency_checker._is_module_available("sys"))
        self.assertTrue(self.dependency_checker._is_module_available("json"))
    ...
    def test_is_module_available_nonexistent(self):
        ...
        self.assertFalse(
            self.dependency_checker._is_module_available("not_a_real_module_123xyz")
        )
    ...
    def test_is_module_available_error(self, mock_find_spec):
        ...
        self.assertFalse(self.dependency_checker._is_module_available("error_module"))
    ...
    def test_is_module_available_tomllib(self):
        ...
        self.assertTrue(self.dependency_checker._is_module_available("tomllib"))
    ...
    def test_is_module_available_tomllib_older_python(self, mock_find_spec):
        ...
        self.assertFalse(self.dependency_checker._is_module_available("tomllib"))
    ...
    #     result = self.dependency_checker.check_dependency("os")
    #     self.assertTrue(result)
    #     self.assertEqual(self.dependency_checker.dependencies["os"], True)
    #     # Check a dependency with an alias
    #     result = self.dependency_checker.check_dependency("sys", alias="system")
    #     self.assertTrue(result)
    #     self.assertEqual(self.dependency_checker.dependencies["system"], True)
    #     # Check a dependency that doesn't exist
    #     result = self.dependency_checker.check_dependency("not_a_real_module_123xyz")
    #     self.assertFalse(result)
    #     self.assertEqual(
    #         self.dependency_checker.dependencies["not_a_real_module_123xyz"], False
    #     )

    # def test_register_feature_all_available(self):
    #     """Test registering a feature with all dependencies available."""
    #     # Register dependencies
    #     self.dependency_checker.check_dependency("os")
    #     self.dependency_checker.check_dependency("sys")
    #     # Register feature
    #     result = self.dependency_checker.register_feature("test_feature", ["os", "sys"])
    #     self.assertTrue(result)
    #     self.assertEqual(self.dependency_checker.features["test_feature"], True)
    ...
    #         self.dependency_checker.logger, "warning"
    #     ) as mock_warning:
    #         result = self.dependency_checker.register_feature(
    #             "test_feature", ["os", "unknown_dep"]
    #         )
    #     # Should auto-check the missing dependency
    #     self.assertFalse(result)
    #     self.assertEqual(self.dependency_checker.features["test_feature"], False)
    ...
    #     self.dependency_checker.check_dependency("os")
    #     self.dependency_checker.check_dependency("not_a_real_module_123xyz")
    #     # Register feature
    #     result = self.dependency_checker.register_feature(
    ...
    #     self.dependency_checker.register_enhancement(
    #         "test_enhancement", callback, ["os", "sys"]
    #     )
    #     # Check that the enhancement was registered
    #     self.assertTrue(self.dependency_checker.features["test_enhancement"])
    #     self.assertEqual(
    #         self.dependency_checker._enhancement_callbacks["test_enhancement"], callback
    #     )
    ...
    #     self.assertFalse(self.dependency_checker.features["test_enhancement"])
    #     self.assertNotIn(
    #         "test_enhancement", self.dependency_checker._enhancement_callbacks
    #     )
    ...
    #     self.dependency_checker.register_enhancement("enhancement1", callback1, ["os"])
    #     self.dependency_checker.register_enhancement("enhancement2", callback2, ["sys"])
    #     # Apply enhancements with kwargs
    #     kwargs = {"arg1": "value1", "arg2": "value2"}
    #     results = self.dependency_checker.apply_enhancements(**kwargs)
    ...
    #     results = self.dependency_checker.apply_enhancements(arg="value")
    ...
    #     self.dependency_checker.check_dependency("os")
    #     self.dependency_checker.check_dependency("not_real_1", alias="Missing 1")
    #     self.dependency_checker.check_dependency("not_real_2", alias="Missing 2")
    ...
    #     # Register dependencies
    #     self.dependency_checker.check_dependency("os")
    #     self.dependency_checker.check_dependency("not_real", alias="Missing Dep")
    #     # Register features
    #     self.dependency_checker.register_feature("Feature 1", ["os"])
    #     self.dependency_checker.register_feature("Feature 2", ["Missing Dep"])
    #     self.dependency_checker.register_feature("Feature 3", ["os", "Missing Dep"])
    #     # Mock the logger
    #     with mock.patch.object(self.dependency_checker.logger, "info") as mock_info:
    #         self.dependency_checker.print_status(show_features=False, show_deps=True)
    ...
    #     # Mock the logger
    #     with mock.patch.object(self.dependency_checker.logger, "info") as mock_info:
    #         self.dependency_checker.print_status()
